...
(* OASIS_START *)
(* DO NOT EDIT (digest: b6d9147f703245859a82ece700a9ffc9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/srdqty/irc-live-stream-bot";
          synopsis =
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/srdqty/irc-live-stream-bot";
                      src_repo_browser =
                        Some
                          "https://github.com/srdqty/irc-live-stream-bot";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Twitch_api"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "twitch-api";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ustream_api"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ustream-api";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Hitbox_api"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hitbox-api";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "irc-live-stream-bot";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("yojson", None);
                           FindlibPackage ("threads", None);
                           FindlibPackage ("easy-irc-client", None);
                           InternalLibrary "twitch_api";
                           InternalLibrary "ustream_api";
                           InternalLibrary "hitbox_api"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "poll_twitch.ml"});
               Executable
                 ({
                     cs_name = "poll_ustream";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "poll_ustream.ml"});
               Executable
                 ({
                     cs_name = "poll_hitbox";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "poll_hitbox.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\1692\187\202\030\2165\213\160L\159\158;\1782W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
